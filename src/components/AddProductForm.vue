<template>
  <form class="form">
    <div class="form__wrapp-field">
      ...
      >
      <span class="form__descr-error"
            :class="{ show: !isNameValidated }"
      >Поле является обязательным</span>
    </div>

    <div class="form__wrapp-field">
      <div class="form__field-label form__field-label-not-necessary">Описание товара</div>
    ...
    <div class="form__wrapp-field">
      ...
      >
      <span class="form__descr-error"
            :class="{ show: !isImageUrlValidated }"
      >Поле является обязательным</span>
    </div>
